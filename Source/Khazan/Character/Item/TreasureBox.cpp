...
ATreasureBox::ATreasureBox()
{
	...
	// 애니메이션 몽타주 저장 
	static ConstructorHelpers::FObjectFinder<UAnimMontage> OpenBoxMontageRef(TEXT("/Game/Blueprint/Item/TreasureBox/AM_OpenBox.AM_OpenBox"));
		...
		if(Actor->ActorHasTag(TEXT("Player")))
		{
			...
			if(pPlayer != NULL)
			{
				if (pPlayer->Get_Ui_Key_Statue() == true)
				{
					...
					{
						PlayAnimMontage(OpenBoxMontage);
